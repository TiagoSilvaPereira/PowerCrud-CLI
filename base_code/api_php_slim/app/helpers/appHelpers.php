...
class helpers {
  ...
  static function jsonResponse( $error = true, $message = '', $table_count = 0, $data = array() ) {
  ...
  static function genToken(){
    ...
    $arr = array(0 => 'AXys', 1 => 'HJV4', 2 => 'RyuO', 3 => 'CBnF', 4 => 'PZQg', 5 => '4VSl');

    $p1 = rand(0, 5);
    $p2 = rand(0, 5);

    $password = $arr[$p1] . $arr[$p2] . rand(233,457);

    $token = strrev($password);
