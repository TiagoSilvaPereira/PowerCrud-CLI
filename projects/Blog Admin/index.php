...
// Models
require_once _APP . "/models/UsersModel.php";
require_once _APP . "/models/CategoriesModel.php";
require_once _APP . "/models/PostsModel.php";


// Controllers
require_once _APP . "/controllers/UsersController.php";
require_once _APP . "/controllers/CategoriesController.php";
require_once _APP . "/controllers/PostsController.php";
